...
int main(){
	...
	do{ // se o usuário recomeçar o jogo e trocar os nomes.
		...
		do{ //jogar mais uma vez
			...
			printf("\n\n\n\n\t\t-> %s sera o simbolo bola \t\t", jogador1);
			...
			do{ //ate alguem ganhar ou dar velha
				...
				do{ //se repetir a posicao
					...
					do { //se a coordenada nao existir
						...
						printf("\n\n\n\t\t Digite a coordenada que voce deseja jogar: \n\n");
						...
						if(l < 1 || l > 3 || c < 1 || c > 3){
							...
							printf("\n\t\t\tX Essa coordenada nao existe, tente de novo... X\n\n");
							Sleep(2000);
							system("cls");
					...
					if(tabela[l][c] == ' '){
						...
						printf("\t\t\tX Essa posicao ja esta preenchida, tente de novo... X");
						//Sleep(2000);
						system("cls");
						printf("\n\n\n\n\n");
						if(jogada % 2 == 0){			
			...
			if(jogada == 9){
				...
				if(jogada % 2 == 0){ //se o jogador 1 ganhar
					...
					if(ganhouPorDiagonal_1() != 0 || ganhouPorDiagonal_2() != 0){
						printf("\n\n\n\t\tPARABENS, o jogador %s venceu por diagonal!! \n\n", jogador1);
					}
			...
			do{ // if the user doesnt type any option down, repeat this part.
				...
				if(op == 1){ //aqui serve pro  jogardor 2 ser a bola, 
					...
					printf("\n\tX Voce nao digitou nenhuma das opcoes, tente novamente... X");
					//Sleep(1800);
	...
	printf("\t\t\tAnimacoes ---------------------------------> Rodrigo Neves\n\n");//Sleep(1000);
	printf("\t\t\tCriacao -----------------------------------> Rodrigo Neves\n\n");//Sleep(1000);
	printf("\t\t\tDublagem ----------------------------------> Rodrigo Neves\n\n");//Sleep(1000);
	printf("\t\t\tProdução Geral ----------------------------> Rodrigo Neves\n\n");//Sleep(1000);
	printf("\t\t\tDirecao -----------------------------------> Rodrigo Neves\n\n");//Sleep(1000);
	printf("\t\t\tPatrocinio --------------------------------> Rodrigo Neves\n\n");//Sleep(1000);
